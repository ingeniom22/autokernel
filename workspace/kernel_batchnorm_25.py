...
Op type: batchnorm
Rank: 25 (1.1% of GPU time)
Model shape: N=1, C=384, H=3, W=80
...
MODEL_SHAPES = {'N': 1, 'C': 384, 'H': 3, 'W': 80}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C': 384, 'H': 3, 'W': 80}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C': 192, 'H': 2, 'W': 40}),
    ("model_double", {'N': 2, 'C': 768, 'H': 6, 'W': 160}),
]
