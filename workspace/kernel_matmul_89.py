...
Op type: matmul
Rank: 89 (0.2% of GPU time)
Model shape: M=40, N=360, K=120
...
MODEL_SHAPES = {'M': 40, 'N': 360, 'K': 120}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 40, 'N': 360, 'K': 120}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 20, 'N': 180, 'K': 60}),
    ("model_double", {'M': 80, 'N': 720, 'K': 240}),
]
