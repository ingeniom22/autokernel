...
Op type: conv2d
Rank: 9 (2.7% of GPU time)
Model shape: N=1, C_in=64, C_out=64, H=48, W=320, KH=3, KW=3, stride_h=1, stride_w=1, pad_h=1, pad_w=1, dil_h=1, dil_w=1, groups=1
...
MODEL_SHAPES = {'N': 1, 'C_in': 64, 'C_out': 64, 'H': 48, 'W': 320, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C_in': 64, 'C_out': 64, 'H': 48, 'W': 320, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C_in': 32, 'C_out': 32, 'H': 24, 'W': 160, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
    ("model_double", {'N': 2, 'C_in': 128, 'C_out': 128, 'H': 96, 'W': 640, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
]
