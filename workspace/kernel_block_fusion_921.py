"""
AutoKernel -- Compiled stage3 wrapper for the recognizer graph stack.
Op type: block_fusion
Rank: 921 (manual graph/block optimization)
Model target: net.backbone.stages.3 on PPOCRv5ServerRecModel
"""

KERNEL_TYPE = "block_fusion"

BLOCK_FUSION_KIND = "compile_original"
TARGET_MODULES = ["net.backbone.stages.3"]
