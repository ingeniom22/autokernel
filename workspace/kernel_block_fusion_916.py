"""
AutoKernel -- Compiled opaque backbone wrapper for the recognizer graph stack.
Op type: block_fusion
Rank: 916 (manual graph/block optimization)
Model target: net.backbone on PPOCRv5ServerRecModel
"""

KERNEL_TYPE = "block_fusion"

BLOCK_FUSION_KIND = "compile_opaque"
TARGET_MODULES = ["net.backbone"]
