...
Op type: conv2d
Rank: 19 (2.0% of GPU time)
Model shape: N=1, C_in=2176, C_out=512, H=6, W=80, KH=1, KW=1, stride_h=1, stride_w=1, pad_h=0, pad_w=0, dil_h=1, dil_w=1, groups=1
...
MODEL_SHAPES = {'N': 1, 'C_in': 2176, 'C_out': 512, 'H': 6, 'W': 80, 'KH': 1, 'KW': 1, 'stride_h': 1, 'stride_w': 1, 'pad_h': 0, 'pad_w': 0, 'dil_h': 1, 'dil_w': 1, 'groups': 1}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C_in': 2176, 'C_out': 512, 'H': 6, 'W': 80, 'KH': 1, 'KW': 1, 'stride_h': 1, 'stride_w': 1, 'pad_h': 0, 'pad_w': 0, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C_in': 1088, 'C_out': 256, 'H': 3, 'W': 40, 'KH': 1, 'KW': 1, 'stride_h': 1, 'stride_w': 1, 'pad_h': 0, 'pad_w': 0, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
    ("model_double", {'N': 2, 'C_in': 4352, 'C_out': 1024, 'H': 12, 'W': 160, 'KH': 1, 'KW': 1, 'stride_h': 1, 'stride_w': 1, 'pad_h': 0, 'pad_w': 0, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
]
