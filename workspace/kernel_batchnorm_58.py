...
Op type: batchnorm
Rank: 58 (0.3% of GPU time)
Model shape: N=1, C=32, H=24, W=160
...
MODEL_SHAPES = {'N': 1, 'C': 32, 'H': 24, 'W': 160}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C': 32, 'H': 24, 'W': 160}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C': 16, 'H': 12, 'W': 80}),
    ("model_double", {'N': 2, 'C': 64, 'H': 48, 'W': 320}),
]
