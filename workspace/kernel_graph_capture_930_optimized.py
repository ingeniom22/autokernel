"""
AutoKernel -- Whole-model CUDA graph capture with adopted static input buffer for PP-OCRv5 recognizer.
Op type: graph_capture
Rank: 930 (manual graph-level optimization)
...
CUDA_GRAPH_INPUT_MODE = "adopt_if_static"
