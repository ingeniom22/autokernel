"""
AutoKernel -- Stage0 blocks-only PP-HGNetV2 wrapper for the recognizer graph stack.
Op type: block_fusion
Rank: 927 (manual graph/block optimization)
Model target: net.backbone.stages.0 on PPOCRv5ServerRecModel
"""

KERNEL_TYPE = "block_fusion"

BLOCK_FUSION_KIND = "hgv2_stage_blocks_only"
