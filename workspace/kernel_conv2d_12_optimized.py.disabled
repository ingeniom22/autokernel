...
Op type: conv2d
Rank: 12 (2.4% of GPU time)
Model shape: N=1, C_in=96, C_out=96, H=12, W=80, KH=3, KW=3, stride_h=1, stride_w=1, pad_h=1, pad_w=1, dil_h=1, dil_w=1, groups=1
...
MODEL_SHAPES = {'N': 1, 'C_in': 96, 'C_out': 96, 'H': 12, 'W': 80, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C_in': 96, 'C_out': 96, 'H': 12, 'W': 80, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C_in': 48, 'C_out': 48, 'H': 6, 'W': 40, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
    ("model_double", {'N': 2, 'C_in': 192, 'C_out': 192, 'H': 24, 'W': 160, 'KH': 3, 'KW': 3, 'stride_h': 1, 'stride_w': 1, 'pad_h': 1, 'pad_w': 1, 'dil_h': 1, 'dil_w': 1, 'groups': 1}),
]
