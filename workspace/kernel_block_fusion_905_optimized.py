"""
AutoKernel -- Stem-level PP-HGNetV2 fusion for the recognizer graph stack.
Op type: block_fusion
Rank: 905 (manual stage/block optimization)
Model target: net.backbone.stem on PPOCRv5ServerRecModel
"""

KERNEL_TYPE = "block_fusion"

BLOCK_FUSION_KIND = "stem_block"
TARGET_MODULES = ["net.backbone.stem"]
