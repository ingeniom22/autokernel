"""
AutoKernel -- Stage2 concat-free squeeze-accumulate wrapper for the recognizer graph stack.
Op type: block_fusion
Rank: 924 (manual graph/block optimization)
Model target: net.backbone.stages.2 on PPOCRv5ServerRecModel
"""

KERNEL_TYPE = "block_fusion"

BLOCK_FUSION_KIND = "hgv2_stage_squeeze_accumulate"
