"""
AutoKernel -- Stage2 block-by-block compiled wrapper for the recognizer graph stack.
Op type: block_fusion
Rank: 919 (manual graph/block optimization)
Model target: net.backbone.stages.2 on PPOCRv5ServerRecModel
"""

KERNEL_TYPE = "block_fusion"

BLOCK_FUSION_KIND = "hgv2_stage_compile_blocks"
