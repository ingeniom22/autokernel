...
Op type: conv2d
Rank: 28 (0.8% of GPU time)
Model shape: N=1, C_in=384, C_out=384, H=3, W=80, KH=5, KW=5, stride_h=1, stride_w=1, pad_h=2, pad_w=2, dil_h=1, dil_w=1, groups=384
...
MODEL_SHAPES = {'N': 1, 'C_in': 384, 'C_out': 384, 'H': 3, 'W': 80, 'KH': 5, 'KW': 5, 'stride_h': 1, 'stride_w': 1, 'pad_h': 2, 'pad_w': 2, 'dil_h': 1, 'dil_w': 1, 'groups': 384}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C_in': 384, 'C_out': 384, 'H': 3, 'W': 80, 'KH': 5, 'KW': 5, 'stride_h': 1, 'stride_w': 1, 'pad_h': 2, 'pad_w': 2, 'dil_h': 1, 'dil_w': 1, 'groups': 384}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C_in': 192, 'C_out': 192, 'H': 2, 'W': 40, 'KH': 5, 'KW': 5, 'stride_h': 1, 'stride_w': 1, 'pad_h': 2, 'pad_w': 2, 'dil_h': 1, 'dil_w': 1, 'groups': 192}),
    ("model_double", {'N': 2, 'C_in': 768, 'C_out': 768, 'H': 6, 'W': 160, 'KH': 5, 'KW': 5, 'stride_h': 1, 'stride_w': 1, 'pad_h': 2, 'pad_w': 2, 'dil_h': 1, 'dil_w': 1, 'groups': 768}),
]
