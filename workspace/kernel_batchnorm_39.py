...
Op type: batchnorm
Rank: 39 (0.6% of GPU time)
Model shape: N=1, C=48, H=12, W=160
...
MODEL_SHAPES = {'N': 1, 'C': 48, 'H': 12, 'W': 160}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C': 48, 'H': 12, 'W': 160}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C': 24, 'H': 6, 'W': 80}),
    ("model_double", {'N': 2, 'C': 96, 'H': 24, 'W': 320}),
]
