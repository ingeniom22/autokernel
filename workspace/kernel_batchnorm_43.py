...
Op type: batchnorm
Rank: 43 (0.5% of GPU time)
Model shape: N=1, C=96, H=12, W=80
...
MODEL_SHAPES = {'N': 1, 'C': 96, 'H': 12, 'W': 80}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'N': 1, 'C': 96, 'H': 12, 'W': 80}),
    # Also test nearby sizes for robustness
    ("model_half", {'N': 1, 'C': 48, 'H': 6, 'W': 40}),
    ("model_double", {'N': 2, 'C': 192, 'H': 24, 'W': 160}),
]
