"""
AutoKernel -- Compiled opaque CTC encoder wrapper for the recognizer graph stack.
Op type: block_fusion
Rank: 918 (manual graph/block optimization)
Model target: net.head.ctc_encoder on PPOCRv5ServerRecModel
"""

KERNEL_TYPE = "block_fusion"

BLOCK_FUSION_KIND = "compile_opaque"
TARGET_MODULES = ["net.head.ctc_encoder"]
