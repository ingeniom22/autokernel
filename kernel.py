...
Op type: matmul
Rank: 88 (0.2% of GPU time)
Model shape: M=40, N=120, K=240
...
MODEL_SHAPES = {'M': 40, 'N': 120, 'K': 240}

# Benchmark config (self-describing -- bench.py can load this dynamically)
TEST_SIZES = [
    ("model_primary", {'M': 40, 'N': 120, 'K': 240}),
    # Also test nearby sizes for robustness
    ("model_half", {'M': 20, 'N': 60, 'K': 120}),
    ("model_double", {'M': 80, 'N': 240, 'K': 480}),
]
